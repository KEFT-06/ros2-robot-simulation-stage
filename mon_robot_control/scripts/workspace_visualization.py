#!/usr/bin/env python3
"""
RGS2-24 : visualisation de l'espace de travail du modele URDF actuel.

Avec deux rotations coaxiales et un tool_link fixe a z=10 mm, l'espace de
position est un point. La figure montre donc surtout l'espace d'orientation yaw.
"""
...
def main():
    ...
    for q1 in q1_range:
        for q2 in q2_range:
            yaw_values.append(math.atan2(math.sin(q1 + q2), math.cos(q1 + q2)))
